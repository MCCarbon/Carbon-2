...
public class TileEntityEndGateway extends WrappedTileEntity {
    ...
    // if (exitPos != null) {
    // // var1.put("ExitPortal", class_dy.a(exitPos)); //TODO: Cannot change
    // this until class_dy is found out
    // }
    // }
    //
    // @Override
    ...
    // // exitPos = class_dy.c(var1.getCompound("ExitPortal")); //TODO: Cannot
    // change this until class_dy is found out
    // }
    //
    // }
    //
    ...
    // List<Entity> list = world.getEntities(Entity.class, new
    // AxisAlignedBB(getPosition(), getPosition().a(1, 1, 1)));
    // if (!list.isEmpty()) {
    ...
    // looger.debug("Best exit position for portal at " + exitPos + " is " +
    // var1);
    // return var1.up();
    // }
    //
    // private void j() {
    // Vec3D var1 = (new Vec3D(getPosition().getX(), 0.0D,
    // getPosition().getZ())).normalize();
    // Vec3D var2 = var1.multiply(1024.0D);
    //
    // int var3;
    // for (var3 = 16; (a(world, var2).g() > 0) && (var3-- > 0); var2 =
    // var2.add(var1.multiply(-16.0D))) {
    ...
    // }
    //
    // private static BlockPosition a(World var0, BlockPosition var1, int var2,
    // boolean var3) {
    ...
    // BlockPosition var8 = new BlockPosition(var1.getX() + var5, var7,
    // var1.getZ() + var6);
    // IBlockData var9 = var0.getType(var8);
    // if (var9.getBlock().isSoildFullCube() && (var3 || (var9.getBlock() !=
    // Blocks.BEDROCK))) {
    // var4 = var8;
    // break;
    // }
    ...
    // return var0.a(MathHelper.floor(var1.x / 16.0D), MathHelper.floor(var1.z /
    // 16.0D));
    // }
    //
    ...
    // BlockPosition var3 = new BlockPosition(((var0.a * 16) + 16) - 1, var2,
    // ((var0.b * 16) + 16) - 1);
    // BlockPosition var4 = null;
    // double var5 = 0.0D;
