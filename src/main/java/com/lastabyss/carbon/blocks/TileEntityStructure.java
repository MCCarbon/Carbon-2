...
public class TileEntityStructure extends TileEntity {
    ...
    // pos = new BlockPosition(var1.getInt("posX"), var1.getInt("posY"),
    // var1.getInt("posZ"));
    // size = new BlockPosition(var1.getInt("sizeX"), var1.getInt("sizeY"),
    // var1.getInt("sizeZ"));
    //
    // try {
    ...
    // world.setTypeAndData(getPosition(), var2.set(BlockStructureBlock.MODE,
    // var1), 2);
    // }
    //
    // }
    ...
    // BlockPosition var3 = new BlockPosition(var1.getX() - 128, 0, var1.getZ()
    // - 128);
    // BlockPosition var4 = new BlockPosition(var1.getX() + 128, 255,
    // var1.getZ() + 128);
    ...
    // if (((var7.d - var7.a) > 1) && ((var7.e - var7.b) > 1) && ((var7.f -
    // var7.c) > 1)) {
    // pos = new BlockPosition((var7.a - var1.getX()) + 1, (var7.b -
    // var1.getY()) + 1, (var7.c - var1.getZ()) + 1);
    // size = new BlockPosition(var7.d - var7.a - 1, var7.e - var7.b - 1, var7.f
    // - var7.c - 1);
    // update();
    // world.notify(var1);
    // return true;
    ...
    // Iterable<TileEntityStructure> var2 = Iterables.filter(var1, (new
    // Predicate<TileEntityStructure>() {
    // @Override
    // public boolean apply(TileEntityStructure var1) {
    // return (var1.mode == TileEntityStructure.EnumMode.CORNER) &&
    // name.equals(var1.name);
    // }
    // }));
    // return Lists.newArrayList(var2);
    // }
    //
    // private List<TileEntityStructure> a(BlockPosition var1, BlockPosition
    // var2) {
    ...
    // (BlockPosition.MutableBlockPosition) var4.next();
    ...
    // Iterator<?> var5 = world.b((Entity) null, (new AxisAlignedBB(var1,
    // var4.add(var1).add(-1, -1, -1)))).iterator();
    //
    // while (var5.hasNext()) {
    ...
    //
    // class_asu var7 = (new
    // class_asu()).a(mirror).a(rotation).a(ignoreEntities).a((class_aeh)
    // null).b(false).c(false);
