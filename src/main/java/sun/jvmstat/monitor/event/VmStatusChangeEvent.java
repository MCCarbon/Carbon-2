...
public class VmStatusChangeEvent extends HostEvent {
     ...
     * @param started the set of Java Virtual Machines started since the last event.
     * @param terminated the set of Java Virtual Machines terminated since the last event.
     */
