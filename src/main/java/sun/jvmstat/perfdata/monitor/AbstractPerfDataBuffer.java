...
public abstract class AbstractPerfDataBuffer {
     ...
     * @throws MonitorException Thrown if an error occurs while communicating with the target Java Virtual Machine.
     */
     ...
     * @return List - a List of {@link Monitor} objects that can be used to monitor the instrumentation objects whose names match the given pattern. If no instrumentation objects have` names matching the given pattern, then an empty List is returned.
     * @throws MonitorException Thrown if an error occurs while communicating with the target Java Virtual Machine.
     ...
     * @throws MonitorException Thrown if communications errors occur while communicating with the target.
     */
