...
public class TypeCode {
     ...
     * @throws IllegalArgumentException Thrown if <code>c</code> is not a valid Java TypeCode.
     */
     ...
     * Map a character value to its corresponding TypeCode object.
     *
     * @param b a byte representing a Java TypeCode. This value is converted into a char and used to find the corresponding TypeCode.
     * @return TypeCode - The TypeCode enumeration object for the given byte.
     * @throws IllegalArgumentException Thrown if <code>v</code> is not a valid Java TypeCode.
     */
