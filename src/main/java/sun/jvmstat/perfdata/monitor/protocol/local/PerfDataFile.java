...
public class PerfDataFile {
     ...
     *
     * @param file A File object representing the name of a shared memory region for a target JVM
     * @return int - the local Java Virtual Machine Identifier for the target associated with the file
     * @throws java.lang.IllegalArgumentException Thrown if the file name does not conform to the expected pattern
     */
